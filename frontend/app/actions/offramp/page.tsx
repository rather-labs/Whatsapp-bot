...
export default function Home() {
  ...
  const [offRampSuccess, setOffRampSuccess] = useState(false); 
  ...
  return (
    <main className="flex flex-col items-center justify-center mt-8">        
      ...
      { address && ( // TODO: remove once off-ramp is available
        <div className="w-full flex justify-center mt-6">
          <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 rounded-md text-center max-w-xl">
            <strong className="block mb-1">Off-Ramp Unavailable</strong>
            <span>
              Off-ramp services are <span className="font-semibold">not available</span> in this Proof of Concept.<br />
            </span>
          </div>
        </div>
      )}
