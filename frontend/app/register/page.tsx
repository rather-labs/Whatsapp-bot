...
export default function Home() {
  ...
  const handleSubmit = async () => {
    if (isConnected && address && whatsappNumber && pin) {
      ...
      alert("Please ensure you are connected to your wallet and have entered a valid PIN");
    }
  };
      ...
      <div className="flex flex-col items-center justify-center mt-8">
        ...
        {address && (
          <div className="flex flex-col gap-6 items-center bg-[#F7F8FA] rounded-2xl p-8 shadow-md max-w-sm w-full mt-8">
            ...
            <button
              type="button"
              disabled={!pin || pin.length < 4 || pin.length > 6}
